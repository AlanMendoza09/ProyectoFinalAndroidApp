...
import edu.itesm.proyecto_final.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
        ...
        bind.loginbtn.setOnClickListener {
            if (bind.correo.text.isNotEmpty() && bind.password.text.isNotEmpty()) {
                ...
                FirebaseAuth.getInstance().signInWithEmailAndPassword(
                    ...
                    if (it.isSuccessful) {
                        Toast.makeText(this, "Bienvenido Al Mundo Del Ahorro!", Toast.LENGTH_LONG)
                                .show()
    ...
    private fun usuarioCreado(){
        ...
        with(builder){
            setTitle("Usuario money manager")
